                    ...
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="{{asset('Home/img/hero-img-1.png')}}"
                                     class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Sell Agri Products</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="{{asset('Home/img/hero-img-2.jpg')}}" class="img-fluid w-100 h-100 rounded"
                                     alt="Second slide">
                                ...
                                <div class="row g-4">
                                        ...
                                        <div class="rounded position-relative fruite-item">
                                            <a href="{{route('productDetail')}}">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    <h4>Grapes</h4>
                                                    <p>This product is best for health purposes. It helps in adding
                                                        blood levels. </p>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                 style="top: 10px; left: 10px;">Apples
                                            </div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Grapes</h4>
            ...
            <div class="owl-carousel testimonial-carousel">
                ...
                <div class="testimonial-item img-border-radius bg-light rounded p-4">
                    <div class="position-relative">
                        ...
                        <div class="d-flex align-items-center flex-nowrap">
                            <div class="bg-secondary rounded">
                                <img src="{{asset('Home/img/testimonial-1.jpg')}}" class="img-fluid rounded"
                                     style="width: 100px; height: 100px;" alt="">
                            </div>
                            <div class="ms-4 d-block">
                                <h4 class="text-dark">Client Name</h4>
